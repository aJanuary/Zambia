...
define("DBUSERID", "zambia");
define("DBPASSWORD", "umk8UHB5azt!tzh*myg");
define("DBDB", "zambia");
define("CON_NAME", "Levitation - Eastercon 2024");
define("BRAINSTORM_EMAIL", "programme@eastercon2024.co.uk");
define("PROGRAM_EMAIL", "programme@eastercon2024.co.uk");
define("CON_NUM_DAYS", 3); // code works for 1 - 8
define("PHP_DEFAULT_TIMEZONE", "EUROPE/LONDON"); // must be valid argument to php date_default_timezone_set()  Should correspond with DB configuration
define("DB_DEFAULT_TIMEZONE", "Europe/London"); // must be valid argument to set time_zone,  Should correspond with PHP configuration
define("CON_START_DATIM", "2024-03-29 00:00:00"); // Broadly used.  Must be in mysql format: "YYYY-MM-DD HH:MM:SS" (HH:00-23) HH:MM:SS probably should be 00:00:00
...
define("ROOT_URL", "https://localhost/"); // URL to reach this zambia server. Required to generate and email password reset link. Include trailing /
...
define("ENCRYPT_KEY", "c12cy57u8qhe58v825kmrwz8zttt2vvmpwn6dbg9f1mb4drfblr885krtndy728h"); // used for encrypting hidden inputs; I suggest finding a random password generator and putting in a 64 character alphanumeric only password
